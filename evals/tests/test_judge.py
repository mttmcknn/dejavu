...
# Adapted for DejaVu catalog and retained execpolicy rules. See evals/upstream/README.md.
import json
import subprocess
import tempfile
import unittest
...
class BlindedJudgeTest(unittest.TestCase):
    ...
    def test_packet_omits_evaluator_owned_project_skill_snapshot(self):
        ...
        skill = workspace / ".agents/skills/dejavu-test-writer/SKILL.md"
        ...
        self.assertNotIn(".agents/skills/dejavu-test-writer/SKILL.md", packet["initial_state"])
    ...
    def test_judge_command_disables_every_skill_and_uses_read_only_sandbox(self):
        ...
        self.assertEqual(4, rendered.count("path = "))
